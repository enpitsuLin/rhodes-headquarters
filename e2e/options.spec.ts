...
import binding from './mocks/binding.json' with { type: 'json' }
import check from './mocks/check.json' with { type: 'json' }
import generate_cred_by_code from './mocks/generate_cred_by_code.json' with { type: 'json' }
import grant from './mocks/grant.json' with { type: 'json' }
import info from './mocks/info.json' with { type: 'json' }
import me from './mocks/me.json' with { type: 'json' }
