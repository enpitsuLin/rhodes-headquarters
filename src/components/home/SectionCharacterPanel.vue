          ...
          <div flex="~ items-center justify-between" flex-1 px-10px>
            <div flex="~ items-baseline" pb-1 pl-2>
              <div flex="~ items-center">
                ...
                <span text-base font-bold>角色列表</span>
                <svg c-border width="6" height="18" viewBox="0 0 6 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button type="button" c="white hover:primary" @click="toPreferences">
            ...
            <ul flex="~ col gap-4px">
              <li v-for="character in characters" :key="character.uid">
                ...
                >
                  ...
                  <div c-white>
                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="m17.723 16-6.134-6.133.944-.944L19.611 16l-7.078 7.077-.944-.944L17.723 16Z" fill="currentColor" /></svg>
                  </div>
                </button>
              </li>
            </ul>
          </div>
          <div py-8px flex="~ justify-center">
            <button
